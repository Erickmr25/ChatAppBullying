...
export default class Chat extends React.Component{
    constructor(props) {
        ...
        this.notificaitonErase = this.notificaitonErase.bind(this);
                ...
                if(item.id != this.currentUserId) {
                    ...
                    viewListUser.push(
                        <button 
                            ...
                            className={classname}
                            onClick = {() => {
                                this.notificaitonErase(item.id)
                ...
                <div className="body">
                    <div className="viewListUser">
                        <div className="profileviewleftside">
                            ...
                            />
                            <button className="Logout" onClick = { this.logout }>Cerrar Sesión</button>
                        </div>
